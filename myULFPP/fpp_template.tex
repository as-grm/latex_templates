...
% Description: This is an unofficial UL-FPP I made from scratch.
...
% ************************************************************
% *** Compile engines:
%     - latex: latex + dvipd + ps2pdf
%     - pdflatex: works fine
%     - xelatex: works fine
%     - lualatex: some pdf problems must be fixed
% ************************************************************ 
...
\titlegraphic{\includegraphics[width=8.0cm]{Theme/Logos/fpp_logo_vertical.pdf}}
