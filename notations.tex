...
\newcommand{\posdm}[2]{\qty[minimum-integer-digits = 3]{#1}{\degree}\:\qty[minimum-integer-digits = 2, minimum-decimal-digits = 1]{#2}{\arcminute}}
\newcommand{\posdmo}[3]{\posdm{#1}{#2}\:\text{#3}}
\newcommand{\posdms}[3]{\qty[minimum-integer-digits = 3]{#1}{\degree}\:\qty[minimum-integer-digits = 2]{#2}{\arcminute}\:\qty[minimum-integer-digits = 2]{#3}{\arcsecond}}
