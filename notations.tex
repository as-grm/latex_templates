...
\usepackage{xcolor}
%
% *** Usage with ifplatform ***
%
%  xelatex needs -shell-escape switch
%
...
\newcommand{\rerr}{R_\text{N}} % relative error
%
...
\newcommand{\HA}[2]{\qty[minimum-integer-digits = 3]{#1}{\degree}\:\qty[minimum-integer-digits = 2, minimum-decimal-digits = 1]{#2}{\arcminute}}
\newcommand{\gha}{\textsc{Gha}}
\newcommand{\sha}{\textsc{Sha}}
\newcommand{\lha}{\textsc{Lha}}
\newcommand{\hang}{\textsc{Ha}}
\newcommand{\dec}{\delta}
...
\newcommand{\LOP}{\textsc{Lop}}
\newcommand{\Hc}{H_\text{c}}
\newcommand{\Ho}{H_\text{o}}
...
\newcommand{\KC}{\text{\textsl{Kc}}}
\newcommand{\DP}{\text{\textsl{Dp}}}
...
% red color
\newcommand{\emphcr}[1]{\textcolor{red}{\textbf{#1}}} 
% blue color
\newcommand{\emphcb}[1]{\textcolor{blue}{\textbf{#1}}}
% default magenta color
\renewcommand{\emphcm}[1]{\textcolor{magenta}{\textbf{#1}}}
% default magenta color
\renewcommand{\emph}[1]{\textcolor{magenta}{\textbf{#1}}}
%
...
\newtcbox{\mymath}[1][]{%
	...
	drop lifted shadow, sharp corners, % senčka, ostri koti
	enhanced, colframe=blue!30!black,
	colback=blue!20, boxrule=0.7pt,
	#1}
