...
%\newcommand{\arcdeg}[1]{\si{\ang{#1;;}}}  % instead use \SI{val}{\degree}
%\newcommand{\arcmin}[1]{\si{\ang{;#1;}}}  % instead use \SI{val}{\arcminute}
%\newcommand{\arcsec}[1]{\si{\ang{;;#1}}}  % instead use \SI{val}{\arcsecond}
\newcommand{\posdm}[2]{\SI{#1}{\degree}\:\SI{#2}{\arcminute}}
\newcommand{\posdmo}[3]{\SI{#1}{\degree}\:\SI{#2}{\arcminute}\:\text{#3}}
\newcommand{\posdms}[3]{\SI{#1}{\degree}\:\SI{#2}{\arcminute}\:\SI{#2}{\arcsecond}}
