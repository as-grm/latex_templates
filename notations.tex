...
%
\newcommand{\lat}[3]{\SI[minimum-integer-digits = 2]{#1}{\degree}\:\SI[minimum-integer-digits = 2]{#2}\:{\arcminute}\:\text{#3}}
\newcommand{\long}[1]{\SI[minimum-integer-digits = 3]{#1}{\degree}\:\SI[minimum-integer-digits = 2]{#2}\:{\arcminute}\:\text{#3}}
\newcommand{\azimuth}[1]{\SI[minimum-integer-digits = 3]{#1}{\degree}}
\newcommand{\altitide}[1]{\SI[minimum-integer-digits = 2]{#1}{\degree}\:\SI[minimum-integer-digits = 2]{#2}}
